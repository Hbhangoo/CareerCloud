   ...
   public  class ApplicantProfileLogic:BaseLogic<ApplicantProfilePoco>
    {
        ...
        protected override void Verify(ApplicantProfilePoco[] pocos)
        {
            ...
            foreach(var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(111, $"CurrentSalary {poco.CurrentSalary}cannot be negative for ApplicantProfile"));
                }
                if (poco.CurrentRate < 0)
                {
                    exceptions.Add(new ValidationException(112, $"CurrentRate {poco.CurrentRate}cannot be negative for ApplicantProfile"));
                }
